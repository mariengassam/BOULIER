...
# Sami BOUHAFSI
# Zakariya EL HADJAJI 
# https://github.com/mariengassam/BOULIER
#Soroban
...
def creation_colonne(coordlignex0):
    ...
    ligne1=canvas.create_line(coordlignex0,0,coordlignex0,240,fill="blue", width=10)
    ...
    chiffresouscolonne=canvas.create_text(coordlignex0,30*9, text=chiffre,fill="purple", font=40)
...
canvas=tk.Canvas(racine,width=1050,height=300,  bg="black")
ligne2=canvas.create_line(0,75,1050,75, fill="purple", width=30)
